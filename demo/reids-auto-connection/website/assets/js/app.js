...
(function () {
  ...
  var KB = [
    ...
    { k: ["inventory","cars","vehicles","what do you have","in stock","selection","suv","truck"], a: "We carry late-model, low-mileage 2020–2025 cars, trucks, SUVs and vans across all makes. Inventory moves fast, so the best way to see what fits your budget is a quick call — want someone to reach out with current options?" },
    ...
    { k: ["where","location","address","directions","map","lewisville"], a: "We're at 867 S Mill St, Lewisville, TX 75057 — easy to reach from all over DFW. Out of the area? Ask me about our fly-in program." },
    { k: ["fly","flight","out of state","out of area","airport","southwest"], a: "Yes! For out-of-area buyers we can arrange a Southwest Airlines flight into Dallas Love Field with courtesy pickup. We approve buyers nationwide." },
    ...
    { k: ["hello","hi","hey","help","start"], a: "Hi there! I'm Dawn, the Reids Auto assistant. I can help with financing after bankruptcy, bad credit, $0 down, inventory, hours, or getting pre-approved. What brings you in today?" },
