...
# ==================== 3. Website cost -> Websites & SEO ====================
{
    ...
    "faqs": [
        ("Is the website really free on a plan?",
         "The website is built, hosted, and included at no extra charge on every monthly plan, with no setup fee. You are paying for the plan, which also handles your Google profile, booking, and review requests. If you would rather just buy a site with no plan, that is $1,500 one-time, yours to keep."),
