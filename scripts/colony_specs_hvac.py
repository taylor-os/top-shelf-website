...
# ============================ HVAC website cost (websites-seo) ============================
{
    ...
    "faqs": [
        ...
        ("Do I have to pay a setup fee?",
         'No. A custom five-page site is included free on every Top Shelf plan with nothing up front, and there is no separate onboarding fee. If you would rather own a site outright without a plan, it is $1,500 one-time, yours to keep.')],
},
