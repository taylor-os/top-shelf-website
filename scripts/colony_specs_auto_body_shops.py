...
# ============ How Much Does an Auto Body Shop Website Cost? (cost -> websites-seo) ============
{
    ...
    "faqs": [
        ...
        ("Do I keep the website if I stop working with you?",
         "Yes. The one-time $1,500 site is yours to keep. On a monthly plan the site is built for you as part of the plan, and we tell you plainly what happens to it if you leave, before you sign anything.")],
