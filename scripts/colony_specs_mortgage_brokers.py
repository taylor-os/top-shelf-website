...
# ============ How Much Does a Mortgage Broker Website Cost? (cost -> websites-seo) ============
{
    ...
    "faqs": [
        ...
        ("Do I keep the website if I stop working with you?",
         "Yes. If you buy the one-time $1,500 site, it is yours to keep, registered in your name. On a monthly plan the site is built for you as part of the plan, and we tell you plainly what happens to it if you leave, before you sign anything.")],
