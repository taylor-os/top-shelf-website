...
# ==================== How Much Does a Gym Website Cost? (cost -> websites-seo) ====================
{
    ...
    "faqs": [
        ...
        ("Do I keep the website if I stop working with you?",
         "Yes. If you buy the one-time $1,500 site, it is yours to keep and host anywhere. On a monthly plan the site is built and hosted for you as part of the plan, and we will tell you plainly what happens to it if you leave, before you sign anything. Your member list is always yours to export.")],
