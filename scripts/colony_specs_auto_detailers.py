...
# ============ How Much Does an Auto Detailing Website Cost? (cost -> websites-seo) ============
{
    ...
    "faqs": [
        ...
        ("What is the most affordable way to get a good detailing site?",
         "On any monthly plan starting at $299 the site is included, built and hosted, with the ongoing SEO handled for you. If you would rather own it outright, the one-time custom build is $1,500 with no setup fee. A cheap DIY template can get you online, but it rarely ranks or turns visitors into booked cars.")],
