...
# ============================ Q5 -> Websites & SEO (cost) ============================
{
    ...
    "faqs": [
        ("Is a website really included free on the plans?",
         "Yes. A new custom five-page site is built, hosted, and published free on every Top Shelf plan, starting at $299 a month with no setup fee. The only time a website costs a flat price is if you want to buy one on its own without a plan, which is $1,500 one time."),
