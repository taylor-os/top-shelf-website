...
# ==================== How Much Does an Orthodontist Website Cost? (cost -> websites-seo) ====================
{
    ...
    "faqs": [
        ...
        ("Do I own the website, and does it work with my scheduling?",
         "Yes. If you buy the one-time $1,500 site it is yours to keep; on a monthly plan it is built for you. Either way the free-consult requests it captures flow to you and can feed the same system that follows up on the ones who do not book right away.")],
