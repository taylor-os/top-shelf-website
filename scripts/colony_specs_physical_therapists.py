...
# ============ How Much Does a Physical Therapy Website Cost? (cost -> websites-seo) ============
{
    ...
    "faqs": [
        ...
        ("Do I own the website, or am I renting it?",
         "You own it. The one-time $1,500 site is yours to keep and host anywhere. On a monthly plan it is built and hosted for you as part of the plan, and before you sign anything we tell you plainly what a change costs and what happens to the site if you ever leave.")],
